...
static string CreateMD5(string input)
{
    ...
    //var inputBytes = Encoding.UTF8.GetBytes(input);         //преобразуем строку в массив байтов
...
static string CreateSHA256(string input)
{
    ...
    //var inputBytes = Encoding.UTF8.GetBytes(input);  //UTF8 лучше использовать для русского текста
